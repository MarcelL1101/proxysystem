...
public class LanguageCommand extends Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (args.length == 0) {
            ProxySystem.getInstance().langeLanguageManager.changeLanguage(player.getUniqueId());
            String messageKey = "language";
            ...
            String localizedMessage = ProxySystem.getInstance().langeLanguageManager.getLocalizedMessageOnUse(player.getUniqueId(), messageKey, "language");
            player.sendMessage(localizedMessage);
        }
    }
